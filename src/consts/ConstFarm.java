...
public class ConstFarm {
    ...
    // ===================== FERTILIZER ITEMS =====================
    // Item ID phân bón
    public static final short FERTILIZER_5M = 2148; // Phân bón 5 phút
    public static final short FERTILIZER_10M = 2149; // Phân bón 10 phút
    public static final short FERTILIZER_20M = 2150; // Phân bón 20 phút
    public static final short FERTILIZER_30M = 2151; // Phân bón 30 phút

    // ===================== PESTICIDE ITEM =====================
    // Item ID thuốc trừ sâu (bình thuốc trừ sâu)
    public static final short PESTICIDE_ITEM_ID = 2152;
