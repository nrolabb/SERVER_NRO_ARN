...
public class ChangeMapService {
    ...
    private void changeMap(Player pl, Zone zoneJoin, int mapId, int zoneId, int x, int y, byte typeSpace) {
        ...
        if (zoneJoin != null && pl.zone != null) {
            ...
            if (zoneJoin.map.mapId == 111 && pl.nPoint.power >= 1_500_000_000L) {
                ...
                Service.gI().sendThongBao(pl, "Sức mạnh phải dưới 1,5 tỉ mới vào được");
                return;
            }
        ...
        if (zoneJoin != null) {
            switch (zoneJoin.map.mapId) {
                ...
                case 103: //võ đài xên
                    ...
                    break;
                case 111:
                    if (player.nPoint.power > 15000000L) {
                        return null;
                    }
                    break;
                case 154:
