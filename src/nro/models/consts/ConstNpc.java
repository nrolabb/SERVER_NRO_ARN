...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "3 sao đen: +20% KI\b4 sao đen: 10 Ngọc mỗi giờ\b"
            + "5 sao đen: +15% Hút Máu\b6 sao đen: +15% Hút Ki\b7 sao đen: 10 Đậu 10 mỗi giờ";
    ...
    public static final String THONG_TIN_DAI_HOI_VO_THUAT = "Lịch thi đấu trong ngày\bGiải Ngoại Hạng 1: 8,14,18h\bGiải Ngoại Hạng 2: 9,13,19h\bGiải Siêu Cấp 2: 10,15,20h\bGiải Siêu cấp 3: 11,16,21h\bGiải Ngoại hạng: 12,17,22,23h\n"
            + "Giải thưởng khi thắng mỗi vòng\bGiải Ngoại Hạng 1: 10k vàng\bGiải Ngoại Hạng 2 1: 10k vàng\bGiải Siêu cấp 2: 6 ngọc\bGiải Siêu cấp 3: 8 ngọc\bGiải Ngoại hạng: 10.000 vàng\bVô địch: 5 viên đá nâng cấp\n"
            + "Lệ phí đăng ký các giải đấu\bGiải Ngoại Hạng 1: 10k vàng\bGiải Ngoại Hạng 2: 10k vàng\bGiải Siêu cấp 2: 6 ngọc\bGiải Siêu cấp 3: 8 ngọc\bGiải Ngoại hạng: 10.000 vàng\n"
    ...
    public static final byte NONG_DAN = 85;
    ...
    public static final int MENU_OPTION_EXCHANGE_SIDE_TASK_POINT = 503;
    public static final int event3 = 3333;
    public static final int event3_1 = 3334;
    public static final int MENU_CHI_CHI_EXCHANGE_COSTUME = 3335;
    public static final int MENU_CHI_CHI_EXCHANGE_CHARM = 3336;
