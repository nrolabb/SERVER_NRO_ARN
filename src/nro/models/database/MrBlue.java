    ...
    public static Player login(MySession session, AntiLogin al) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (secondsPass1 < 0) secondsPass1 = Manager.SECOND_WAIT_LOGIN;
                if (secondsPass < 0) secondsPass = Manager.SECOND_WAIT_LOGIN;
...
// }
    ...
    timeNuocMia3 = (int) Long.parseLong(String.valueOf(dataArray.get(29)));
            ...
            if (dataArray.size() > 6) {
                player.playerTask.sideTask.point = Integer.parseInt(String.valueOf(dataArray.get(6)));
            }
...
if (dataArray.size() >= 17) {
    player.luckyRoundPoint = Integer.parseInt(dataArray.get(10).toString());
    player.reward100 = Integer.parseInt(dataArray.get(11).toString()) == 1;
    player.reward200 = Integer.parseInt(dataArray.get(12).toString()) == 1;
    player.reward300 = Integer.parseInt(dataArray.get(13).toString()) == 1;
    player.reward500 = Integer.parseInt(dataArray.get(14).toString()) == 1;
        player.reward700 = Integer.parseInt(dataArray.get(15).toString()) == 1;
    player.reward1000 = Integer.parseInt(dataArray.get(16).toString()) == 1;
