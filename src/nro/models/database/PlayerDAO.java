...
public class PlayerDAO {
    ...
    public static boolean createNewPlayer(int userId, String name, byte gender, int hair) {
        try {
            ...
            int greenGem = (Manager.TEST) ? 1000000000 : 500;
            dataArray.add(500000); //vàng
        ...
        // item.add(5);
            ...
            dataArray.add(0); //điểm nhiệm vụ bò mộng
    ...
    public static void updatePlayer(Player player) {
        if (player != null && player.idMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                dataArray.add(player.playerTask.sideTask.point);
...
//                 dataArray.add(player.luckyRoundPoint);
// dataArray.add(player.reward100 ? 1 : 0);
// dataArray.add(player.reward200 ? 1 : 0);
// dataArray.add(player.reward300 ? 1 : 0);
// dataArray.add(player.reward500 ? 1 : 0);
// dataArray.add(player.reward700 ? 1 : 0);
// dataArray.add(player.reward1000 ? 1 : 0);
...
public static void updateVnd(Player player) {
