...
public class RewardService {
   ...
   public List<Item> getListItemLuckyRound(Player player, int num, boolean vip) {
    ...
    for (int i = 0; i < num; i++) {
        ...
        Item it;
        int rate = Util.nextInt(1, 101); // 1 -> 100

        // =========================
        // 60% - 190 x1.000.000
        // =========================
        if (rate <= 80) {
            it = ItemService.gI().createNewItem((short) 190);
            it.quantity = 100_000;
            list.add(it);
            continue;
        }
      ...
      // =========================
if (rate <= 95) {
    it = ItemService.gI().createNewItem((short) 1507);
    it.quantity = 1;
    list.add(it);
    continue;
}
        ...
        // =========================
        if (rate <= 98) {
            it = ItemService.gI().createNewItem((short) 532);
            it.itemOptions.clear();

            it.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 6)));  // 1-5
            it.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 6)));
            it.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 6)));
  it.itemOptions.add(new Item.ItemOption(30, Util.nextInt(1, 2)));
            if (Util.isTrue(90, 100)) {
                it.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 3))); // 1-2
            }
        ...
        // =========================
        if (rate <= 100) {
            it = ItemService.gI().createNewItem((short) 1680);
            it.itemOptions.clear();

            it.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 13))); // 1-12
            it.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 13)));
            it.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 13)));
  it.itemOptions.add(new Item.ItemOption(30, Util.nextInt(1, 2)));
        ...
        // 3% - 1114 (op 1-17)
        // =========================
        it = ItemService.gI().createNewItem((short) 1631);
        it.itemOptions.clear();

        it.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 18))); // 1-17
        it.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 18)));
        it.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 18)));
  it.itemOptions.add(new Item.ItemOption(30, Util.nextInt(1, 2)));
        if (Util.isTrue(90, 100)) {
            it.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 3))); // 1-2
        }
