...
public class CropTemplate {
    ...
    public short imgYoung; // Ảnh giai đoạn cây non (STAGE_YOUNG)
    public short imgMature; // Ảnh giai đoạn trưởng thành (STAGE_MATURE)
    public short imgWithered; // Ảnh giai đoạn héo (STAGE_WITHERED)
