            ...
            if (select == 0) {
                ...
                if (nro.models.database.PlayerDAO.subvnd(player, nro.models.server.Manager.ACTIVATION_FEE)) {
                        ...
                        if (player.getSession().xacNhanGioiThieu != 0) {
                            ...
                            if (refPlayer != null) {
                                ...
                                Service.gI().sendThongBaoOK(refPlayer,
                                        "Người bạn giới thiệu đã kích hoạt tài khoản!\nBạn nhận được 10.000 VNĐ.");
                            } else {
                                long playerId = -1;
                                ...
                                rs2.dispose();
                                if (playerId != -1) {
                                    nro.models.player.Player offlinePlayer = nro.models.database.MrBlue
                                            .loadById(playerId);
                    ...
                    Service.gI().sendThongBao(player,
                            "Kích hoạt tài khoản thành công! Bạn nhận được 10.000 Ngọc xanh và 1.000 thỏi vàng.");
                } else {
