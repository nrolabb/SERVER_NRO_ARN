...
public class CheTaoCuonSachCu {
    ...
    private static final int REQUIRED_TRANG_SACH_CU = 99;
    private static final int REQUIRED_BIA_SACH = 1;
    private static final int SUCCESS_RATE_PERCENT = 20;
    private static final int TRANG_SACH_CU_LOSS_ON_FAIL = 9;
    ...
    public static void showCombine(Player player) {
        ...
        StringBuilder text = new StringBuilder()
            ...
            .append(ConstFont.BOLD_RED).append("Thất bại mất 9 trang sách và 1 bìa sách");
