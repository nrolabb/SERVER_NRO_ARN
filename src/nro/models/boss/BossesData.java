...
//**************************************************************************
    ...
    public static final BossData SIEU_BO_HUNG_1 = new BossData(
            ...
            new int[][]{
                ...
                {Skill.LIEN_HOAN, 7, 1000},
                            {Skill.THAI_DUONG_HA_SAN, 7, 50000},
                {Skill.TAI_TAO_NANG_LUONG, 7, 100000}},//skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            REST_30_M,
    ...
    public static final BossData SOI_HEC_QUYN = new BossData(
            ...
            1000, //dame
            new int[]{500000}, //hp
            new int[]{63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 79, 80},
            new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
                {Skill.GALICK, 7, 1000},},
            //skill
    ...
    public static final BossData TAU_PAY_PAY_DONG_NAM_KARIN = new BossData(
            ...
            new int[][]{
                {Skill.KAMEJOKO, 1, 500},  {Skill.TAI_TAO_NANG_LUONG, 7, 20000},
                {Skill.DEMON, 1, 200},},
            //skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
 ...
 {Skill.KAMEJOKO, 7, 1000},
    ...
    public static final BossData CADIC_M = new BossData(
            "Cadic M", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1715, 1716, 1717, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
            new int[]{6000000}, //hp
    ...
    public static final BossData BABY_3 = new BossData(
      ...
      public static final BossData B = new BossData(
            "Frost 1",
            ConstPlayer.XAYDA,
            new short[]{493, 494, 495, -1, -1, -1},
            10000,
            new int[]{50000000},
             new int[]{110},
            new int[][]{
